 ...
 */
class Language extends \DROUSS\BookBundle\Entity\Language implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'DROUSS\\BookBundle\\Entity\\Language' . "\0" . 'id', '' . "\0" . 'DROUSS\\BookBundle\\Entity\\Language' . "\0" . 'name', '' . "\0" . 'DROUSS\\BookBundle\\Entity\\Language' . "\0" . 'Book', '' . "\0" . 'DROUSS\\BookBundle\\Entity\\Language' . "\0" . 'Publication');
        }
