 ...
 */
class Science extends \DROUSS\BookBundle\Entity\Science implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'DROUSS\\BookBundle\\Entity\\Science' . "\0" . 'id', '' . "\0" . 'DROUSS\\BookBundle\\Entity\\Science' . "\0" . 'name', '' . "\0" . 'DROUSS\\BookBundle\\Entity\\Science' . "\0" . 'Book');
        }
