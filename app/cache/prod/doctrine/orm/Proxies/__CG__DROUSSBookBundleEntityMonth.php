 ...
 */
class Month extends \DROUSS\BookBundle\Entity\Month implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'DROUSS\\BookBundle\\Entity\\Month' . "\0" . 'id', '' . "\0" . 'DROUSS\\BookBundle\\Entity\\Month' . "\0" . 'name', '' . "\0" . 'DROUSS\\BookBundle\\Entity\\Month' . "\0" . 'Book');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Month $proxy) {
