 ...
 */
class SubCategory extends \DROUSS\BookBundle\Entity\SubCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'DROUSS\\BookBundle\\Entity\\SubCategory' . "\0" . 'id', '' . "\0" . 'DROUSS\\BookBundle\\Entity\\SubCategory' . "\0" . 'name', '' . "\0" . 'DROUSS\\BookBundle\\Entity\\SubCategory' . "\0" . 'book', '' . "\0" . 'DROUSS\\BookBundle\\Entity\\SubCategory' . "\0" . 'category');
        }
