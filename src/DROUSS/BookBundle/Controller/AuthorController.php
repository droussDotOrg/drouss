...
use DROUSS\BookBundle\Form\AuthorType;
...
class AuthorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DROUSSBookBundle:Author')->findAll();

        return $this->render('DROUSSBookBundle:Author:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('DROUSSBookBundle:Author:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DROUSSBookBundle:Author')->find($id);
        ...
        return $this->render('DROUSSBookBundle:Author:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('DROUSSBookBundle:Author:edit.html.twig', array(
            'entity'      => $entity,
